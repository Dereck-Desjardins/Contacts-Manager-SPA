    ...
    return $(`
     <div class="contactRow" contact_id=${bookmark.Id}">
        <div class="bookmarkContainer noselect">
            <div class="bookmarkLayout">
                <span class="bookmarkTitle"><img class="bookmarkFavicon"src="http://www.google.com/s2/favicons?domain=${bookmark.Url}">${bookmark.Title}</span>
                <a href="https://${bookmark.Url}" target="_blank" ><span class="bookmarkCategory">${bookmark.Category}</span></a>
            </div>
            <div class="contactCommandPanel">
